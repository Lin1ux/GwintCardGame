...
void CardList::SetCards()
{
	...
	FrozenChempion = Card(false, front, 6, 20, AllSkills::None, "Czempion", Images::FrozenChempion);
	FrozenDog = Card(false, front, 4, 30, AllSkills::Horde, "Ogar Mrozu", Images::FrozenDog);
	Golem = Card(false, front, 5, 15, AllSkills::None, "Golem", Images::Golem);
	...
	Seraphin = Card(false, front, 7, 50, AllSkills::Medic, "Serafin", Images::Seraphin);
